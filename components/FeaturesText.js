  ...
  return (
    <div
      ...
      <div className="flex flex-col flex-1 justify-start items-center">
        <img src={`/assets/icons/${featureOne.icon}.png`} className="mb-5" />
      ...
      <div className="flex flex-col flex-1 justify-start items-center">
        <img src={`/assets/icons/${featureTwo.icon}.png`} className="mb-5" />
        <h5 className="mb-5 md:text-[1.25rem] text-[1rem] capitalize">
          {featureTwo.title}
        </h5>
      ...
      <div className="flex flex-col flex-1 justify-start items-center">
        <img src={`/assets/icons/${featureThree.icon}.png`} className="mb-5" />
        <h5 className="mb-5 md:text-[1.25rem] text-[1rem] capitalize">
          {featureThree.title}
        </h5>
